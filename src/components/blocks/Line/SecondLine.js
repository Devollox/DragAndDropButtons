...
export default function SecondLine() {
    let getPositionArrayUser = Object.assign({}, $('#getButton').position());
    let getPositionArrayPlain = Object.assign({}, $('#getPlain').position());
    ...
    let p2 = {x: getPositionArrayUser.left + 255 + 30000, y: getPositionArrayUser.top + 120 + 30000}
    let p1 = {x: getPositionArrayPlain.left + 155 + 30000, y: getPositionArrayPlain.top + 30000}
